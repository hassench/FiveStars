	...
	public class AccountController : Controller
	{
		...
		public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
		{
            ...
            if (ModelState.IsValid)
			{
				...
				if (user != null)
				{
                    ...
                    if (returnUrl == null)
                    {
                        if (UserManager.IsInRole(user.Id,"Auditeur"))
                        {
                            return RedirectToAction("Index", "Auditeur");
                        }
                        else if (UserManager.IsInRole(user.Id, "Pilote"))
                        {
		...
		public async Task<ActionResult> Register(RegisterViewModel model)
		{
			if (ModelState.IsValid)
			{
				...
				Auditeur formauditeur = new Auditeur { Nom = model.Nom, Prenom = model.Prenom, Affectation = model.Affectation, Telephone = model.Telephone, DateIntroBaseAuditeur = DateTime.Now };


				var user = new ApplicationUser() { UserName = model.Email, Email = model.Email, auditeur = formauditeur };
